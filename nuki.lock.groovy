...
metadata {
    ...
    definition (name: "Nuki Lock", namespace: "Volski", author: "Volski") {
        capability "Actuator"
        capability "Sensor"
    ...
    tiles {
        multiAttributeTile(name:"lock", type: "generic", width: 6, height: 4){
            ...
            //}
            tileAttribute ("device.strBattery", key: "SECONDARY_CONTROL") {
                attributeState "strBattery", label: 'Battery ${currentValue}'
            }
         }
	...
	httpGet(params)
		{resp ->           
            ...
            log.debug "Battery is Critical: ${resp.data.state.batteryCritical}"
            	...
            	sendEvent(name:"strBattery", value: "OK")
               	}
                else
                {
            	//sendEvent(name:"battery", value: 0)
                sendEvent(name:"strBattery", value: "Low")
                }
